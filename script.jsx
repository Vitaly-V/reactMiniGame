    ...
    render: function () {
        ...
        switch (correct) {
            ...
            default :
                ...
                button = (
                    <button className="btn btn-primary" disabled={disabled} onClick={this.props.checkAnswer}>=</button>
                );
        }
...
var Game = React.createClass({
    ...
    unselectNumber: function (clickedNumber) {
        var selectedNumbers = this.state.selectedNumbers,
            indexOfNumbers = selectedNumbers.indexOf(clickedNumber);

        selectedNumbers.splice(indexOfNumbers, 1);
